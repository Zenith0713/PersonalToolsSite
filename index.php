...
<body class="container w-100 mw-100">
    <section class="row">
        <article class="col bg-primary">
            <h2>Todo :</h2>
            <p>Liste de tache modifiable (chose a faire, course, etc...)</p>
        </article>
    ...
    <section class="row">
        ...
        <article class="col bg-info">
            <h2>Test</h2>
            <p>test, nouvelles choses que je veux faire</p>
        </article>
    </section>
